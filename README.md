...
This library provides [_Spitch SDK_ for _iOS_] – a way to integrate _Spitch_ service into your _iOS_ app.
...
```
pod 'SpitchClientLibrary', :git => 'https://github.com/SpitchChatSDK/spitch-client-sdk-ios', :branch => 'master'
```
...
```
github "SpitchChatSDK/spitch-client-sdk-ios" 
```

### Swift Package Manager

1. Select File > Swift Packages > Add Package Dependency. Enter 'https://github.com/SpitchChatSDK/spitch-client-sdk-ios' in the "Choose Package Repository" dialog.
 2. In the next page, specify the version resolving rule as "Up to Next Major" with the latest 'spitch-client-sdk-ios' release.
 3. After Xcode checking out the source and resolving the version, you can choose the "SpitchClientLibrary" library and add it to your app target.

### Additional notes

#### Objective-C

Trying to integrate _WebimClientLibrary_ into your _Objective-C_ code? Try out our [_WebimClientLibraryWrapper_](https://github.com/SpitchChatSDK/spitch-client-sdk-ios-wrapper).
...
Methods for working with remote notifications by _Spitch_ service are described inside **WebimRemoteNotification.swift** file.
...
* `P.WM` means that operator sent a widget message (for this functionality support one should contact _Spitch_ support).
...
Entities and methods described above are all that it necessary for working in an app with _Spitch_ service and even more.
